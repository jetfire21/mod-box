...
<!-- 				
 ...
 -->				
			...
			<div class="h-phone">
				...
				<img class="blue-phone"  src="<?php echo get_template_directory_uri();?>/images/head/blue-phone.png">
				<img class="white-phone" src="<?php echo get_template_directory_uri();?>/images/head/white-phone.png">
				<span>
				<?php
					 $option = get_option('alex_upload_file_option');
					 if( !empty($option['phone']) ) echo $option['phone'];
...
<!-- 	<object type="image/svg+xml" class="c-bg front-right" data="<?php echo get_template_directory_uri(); ?>/images/content/comb_bg.svg" fill="#f00" alt="The image wasn't found"></object>
 -->
 	<div class="bg-kvadratiki-home"></div>
	<div class="container">
...
<!-- 
 ...
 -->			
		...
		<div class="f-copy-m">
				<span>Modulbox.ru © 2015 Все права защищены.<br/>Дизайн: <a target="_blank" href="http://xankina.com">Ханкина</a></span>
			</div>
