<?php
/*
WP Post Template: Шаблон-Информация
 ...
 -->				
			    ...
			    <?php if($query->have_posts() ): ?>
				    ...
				    <?php while($query->have_posts() ) : $query->the_post();?>    
						...
						<a class="arenda-link <?php echo $cur_arenda;?>" data-post-id="<?php echo $post->ID;?>" href="<?php echo get_permalink();?>"><?php echo the_title(); ?></a>
								<?php
									 $post_id .= $post->ID.",";
								?>				
							</li>
